const httpProxy = require('http-proxy'),
    ...
    createPathRewriter = require('./path_rewriter.js'),
    debug = require('debug')('wind:proxy');
/**
...
const getProxyEnabledCallback = app => {
    ...
    const applyPathRewrite = (req, pathRewriter) => {
        ...
        proxy = httpProxy.createProxyServer(Object.assign({
            changeOrigin: true
    ...
    const enableCors = function(req, res) {
        ...
        onProxyError = (errorInfo, req, response, target) => {
