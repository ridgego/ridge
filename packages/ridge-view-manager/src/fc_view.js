...
import { shortid } from '@gw/editor-kernel/src/utils';
const log = debug('runtime:fc-view'),
    captureEvents = ['onclick', 'ondblclick', 'onmouseup', 'onmousedown', 'onmousemove', 'onmouseout', 'onmouseenter', 'onmouseover', 'oncontextmenu'];
...
class FCView {
    ...
    constructor({ el, fcInstanceConfig, loader, apolloApp, contextVariables, scopeVariables, pageId, preloadChild, decorators }) {
        this.uuid = shortid(10);
        this.fcInstanceConfig = fcInstanceConfig || {};
        this.fcId = fcInstanceConfig.guid || shortid(6);
        this.pageId = pageId;
